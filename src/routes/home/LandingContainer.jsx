                            ...
                            return (
                                <div key={meal.id} className='w-full h-[90vh] max-xl:h-[85vh] max-lg:h-[80vh] max-md:h-[70vh] relative'>
                                    ...
                                    <div className='w-[100%] h-[100%] bg-[rgba(0,0,0,0.4)] absolute top-0 left-0 flex flex-col justify-center  max-md:gap-5 px-10 max-lg:px-5'>
                                        ...
                                        <h1 className='text-[4.5em] font-bold max-md:font-light max-lg:text-[3em] max-md:text-[2em]'>Delicious Recipes</h1>
                                        <p className='w-[40%] font-light max-md:text-[.9em] max-lg:w-[70%] max-md:w-[100%]'>
