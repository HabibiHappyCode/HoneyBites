...
function About() {
    return (
        <div className="flex justify-center items-center h-auto gap-10 max-lg:gap-4 p-15 px-25 max-[1198px]:px-18 max-lg:px-5 max-lg:py-15  max-md:px-5 max-md:flex-wrap">
